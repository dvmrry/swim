...
bool config_set(Config *c, const char *key, const char *value) {
    if (strcmp(key, "general.homepage") == 0 || strcmp(key, "homepage") == 0) {
        ...
        if (strcmp(value, "always") == 0 || strcmp(value, "true") == 0 || strcmp(value, "1") == 0) {
            snprintf(c->tab_bar, sizeof(c->tab_bar), "always");
        } else if (strcmp(value, "never") == 0 || strcmp(value, "false") == 0 || strcmp(value, "0") == 0) {
            snprintf(c->tab_bar, sizeof(c->tab_bar), "never");
        ...
        if (strcmp(value, "always") == 0 || strcmp(value, "true") == 0 || strcmp(value, "1") == 0) {
            ...
            snprintf(c->status_bar, sizeof(c->status_bar), "never");
        } else if (strcmp(value, "auto") == 0) {
            snprintf(c->status_bar, sizeof(c->status_bar), "auto");
        } else {
            return false;
        }
        ...
        c->compact_titlebar = (strcmp(value, "true") == 0 || strcmp(value, "1") == 0);
        ...
        c->dark_mode = (strcmp(value, "true") == 0 || strcmp(value, "1") == 0);
