...
Endpoints: /health, /state, /screenshot, /extract, /interact, /click, /fill, /select, /query, /tab, /wait, /wait_for, /action, /command, /key, /eval, /batch, /resize
...
Tools: navigate, screenshot, extract, interact, fill, select, query, tab, wait_for, execute, action, state, click, key
